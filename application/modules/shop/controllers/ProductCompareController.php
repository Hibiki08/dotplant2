...
class ProductCompareController extends Controller
{
    ...
    {
        $this->layout = '@webroot/theme/views/modules/basic/layouts/simple';
        ...
        return $this->render(
            ...
            [
                ...
                'message' => Yii::t('app', 'Нет продуктов для сравнения'), // todo заменить на языковые переменные 'No products for comparing'),
                'object' => $object,
                'products' => $products,
            ]
        );
