...
?>
<table class="user-profile__user-order-table" id="cart-table">
    <thead>
        <tr>
            <th><?=Yii::t('app', 'Внешний вид')?></th>
    ...
    <?php foreach ($items as $item): ?>
        <tr>
            <td class="image" data-label="Внешний вид">
                <?= Html::a(
            ...
            <td class="title" data-label="Наименование">
                <?= Html::a(
            ...
            <td class="price" data-label="Цена">
                <?=
                $mainCurrency->format(
                    $item->price_per_pcs
                )
            ...
            <td class="qty" data-label="Количество"><?= $item->quantity ?></td>
            <td class="ammount" data-label="Сумма">
                <?php
