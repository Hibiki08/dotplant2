...
<div class="row">
    ...
    <div class="col-md-9" id="jstree-more">
        <?=DynaGrid::widget(
            [
                'options' => [
                    'id' => 'Product-grid',
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => [
                            0 => Yii::t('app', 'Все'),
                            1 => Yii::t('app', 'Без веса'),
                        ],
                        'value' => function (Product $model) {
                            return (!$model->brutto) ? 'Не указано' : 'Указано';
                        }
                    ],
                    ...
                    [
                        ...
                        'filter' => [
                            0 => Yii::t('app', 'Все'),
                            1 => Yii::t('app', 'Без разм.уп.'),
                        ],
                        'value' => function (Product $model) {
                            return (!$model->brutto_width ||!$model->brutto_height ||!$model->brutto_length) ? 'Не указано' : 'Указано';
                        }
                    ],
