...
<div class="<?= (($listDisplay == 'grid') ? 'category__list-column col-xl-4 col-md-6 col-6': 'category__list-column col-12') ?>">
    <a href="<?= $url ?>">
        <div class="<?= (($listDisplay == 'grid') ? 'slider-item category__item' : 'slider-item category__item grid-to-row') ?>">
            ...
            <div class="fav-button js__fav-button d-lg-block d-sm-none d-none <?= (Yii::$app->user->isGuest ? '' : 'js__fav-button') ?>
                    <?= $product->inDefaultWishlist() ? 'active' : '' ?>  d-lg-block d-sm-none d-none"
            ...
            <div class="category__item-info">
                ...
                <div class="category__item-price-wrapper">
