...
class AboutCityController extends BackendController
{
    use BackendRedirect;
    ...
    public function actionIndex()
    {
        $searchModel = new SearchModel(
            [
                'model' => SeoAboutCityText::className(),
    ...
    /**
     * Updates an existing SeoAboutCityText model.
    ...
    /**
     * Deletes an existing SeoAboutCityText model.
     *
    ...
    /**
     * Finds the SeoAboutCityText model based on its primary key value.
     *
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @param string $id
     *
     * @return SeoAboutCityText the loaded model
     *
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SeoAboutCityText::findOne($id)) !== null) {
            return $model;
        } else {
