...
class CategoryVarsController extends BackendController
{
    use BackendRedirect;
    ...
    public function actionIndex()
    {
        $searchModel = new SearchModel(
            [
                'model' => SeoCategoryVar::className(),
    ...
    /**
     * Updates an existing SeoCategoryVar model.
    ...
    /**
     * Deletes an existing SeoCategoryVar model.
     *
    ...
    /**
     * Finds the SeoCategoryVar model based on its primary key value.
     *
     * If the model is not found, a 404 HTTP exception will be thrown.
     *
     * @param string $id
     *
     * @return SeoCategoryVar the loaded model
     *
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SeoCategoryVar::findOne($id)) !== null) {
            return $model;
        } else {
