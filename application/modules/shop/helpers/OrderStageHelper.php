        ...
        return array_reduce(
            ...
            function ($result, $item) {
                ...
                $result[] = [
                    ...
                    'url' => Url::to(['/shop/cart/stage-leaf', 'id' => $item->id], false)
                ];
                return $result;
            },
            []
        ...
        return array_reduce(
            ...
            function ($result, $item) {
                ...
                if (0 === intval($item->stageFrom->immutable_by_user)) {
                    $result[] = [
                        'label' => \Yii::t('app', 'предидущий шаг'), // todo вернуть перевод 'Previous step'),
                        'css' => $item->button_css_class,
                        'url' => Url::to(['/shop/cart/stage-leaf', 'id' => $item->id, 'previous' => 1], false)
                    ];
                }
                return $result;
            },
