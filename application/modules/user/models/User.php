...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        return [
            ...
            'registerService' => ['email', 'first_name', 'last_name', 'phone'],
            'updateProfile' => ['email', 'first_name', 'last_name', 'phone',],
            'completeRegistration' => ['first_name', 'last_name', 'username', 'email', 'phone'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'confirmPassword' => Yii::t('app', 'Повторить пароль'),
        ];
