                    ...
                    <?php foreach($models as $i => $model): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?= $form->field($model, "[$i]product_id")->hiddenInput()->label(false) ?>
