    ...
    <div role="tabpanel" class="tab-pane active" id="tab-main">
        <div class="row">
            <div class="col-md-6">
                ...
                <?= $form->field($model, 'sale')->widget(\kartik\switchinput\SwitchInput::className()) ?>
                ...
                <div class="row bordered">
                    <div class="col-lg-12 text-center pt-2 pb-2">Размеры упаковки (см) и брутто вес(граммы)</div>
                    <div class="col-lg-3"><?= $form->field($model, 'brutto_length')?></div>
                    <div class="col-lg-3"><?= $form->field($model, 'brutto_width')?></div>
                    <div class="col-lg-3"><?= $form->field($model, 'brutto_height')?></div>
                    <div class="col-lg-3"><?= $form->field($model, 'brutto')?></div>
                </div>
                ...
                <?=$form->field($model, 'sort_order')->widget(
