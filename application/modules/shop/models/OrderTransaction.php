...
class OrderTransaction extends ActiveRecord
{
    ...
    private $statusTransaction = [
        OrderTransaction::TRANSACTION_START => 'Начало',
        OrderTransaction::TRANSACTION_CHECKING => 'На проверке',
        OrderTransaction::TRANSACTION_TIMEOUT => 'Вышло время',
        OrderTransaction::TRANSACTION_ROLLBACK => 'Возврат',
        OrderTransaction::TRANSACTION_SUCCESS => 'Оплачено',
        OrderTransaction::TRANSACTION_ERROR => 'Ошибка',
        /*
    ...
    public static function createForOrder(Order $order)
    {
        ...
        $model = new static();
            ...
            $model->total_sum = $order->fullPrice;
