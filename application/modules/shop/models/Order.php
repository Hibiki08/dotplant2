...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function getFullPrice()
    {
        ...
        if(!is_null($this->shippingOption) && ($this->shippingOption->id == 2 || $this->shippingOption->id == 1)) {
            $fullPrice += $this->orderDeliveryInformation->shipping_price_total;

        } elseif (!is_null($this->shippingOption)) {
